...
The `mode` for each file is used to set the mode after the file is written to the store. If the mode doesn't exist in the JSON, it defaults to `0400` to make the file read-only.
